...
public class Chessboard {
    BufferedImage chessboard = new SaveFile("chessboard.png").getImage();
    BufferedImage chessboardPrint = new SaveFile("chessboard_print.png").getImage();

    UserInterface board;
    UserInterface boardPrint;
    
    BufferedImage[][][] pieces = new BufferedImage[2][6][3];
        ...
        for (int x = 0; x < pieces.length; x++) {
            ...
            for (int y = 0; y < pieces[x].length; y++) {
                ...
                for (int z = 0; z < pieces[x][y].length; z++) {
                    ...
                    pieces[x][y][z] = new SaveFile(file + ".png").getImage();
     ...
     * @param xField the x position (0-7)
     */
